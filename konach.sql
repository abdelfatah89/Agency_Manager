...
--
-- Host: localhost
-- Generation Time: Mar 19, 2026 at 11:26 AM
...
--
-- Table structure for table `invoice_number_counters`
--

CREATE TABLE `invoice_number_counters` (
  `id` int(11) NOT NULL,
  `period_key` varchar(6) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sequence_value` int(11) NOT NULL DEFAULT '0',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `invoices`
  ...
  ADD UNIQUE KEY `uq_invoice_source_idem` (`source_type`,`idempotency_key`),
  ADD KEY `idx_invoices_issue_date` (`issue_date`),
  ADD KEY `idx_invoices_period` (`period_key`);

--
-- Indexes for table `invoice_number_counters`
--
ALTER TABLE `invoice_number_counters`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `period_key` (`period_key`);
...
--
-- AUTO_INCREMENT for table `invoice_number_counters`
--
ALTER TABLE `invoice_number_counters`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
