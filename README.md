...
2. أنشئ قاعدة البيانات (مثال: konach_new).
3. استورد ملف البنية:
   - استخدم konach_new.sql أو konach_import_ready.sql حسب بيئتك.
4. حدّث ملف .env بقيم MySQL الصحيحة:
   - DB_HOST
   - DB_PORT
   - DB_USER
   - DB_PASSWORD
...
ملاحظة: التطبيق يحتوي منطق إعداد بسيط عند التشغيل الأول إذا كانت بيانات .env صحيحة.
